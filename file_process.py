...
def classify(predictor, file_dir=FLAGS.file_dir, out_dir=FLAGS.out_dir, sentences_num=FLAGS.sentences_num,
             num_limits=FLAGS.num_limits):
    ...
    read_counter = 0
    # 先把所有数据读进来，内存应该够用
    lines = [line.strip()[:20] for line in input_file.readlines()]
